...
public class SvgGeneratorService {
    ...
    public SvgGeneratorService() {
        this.errorTemplate = readTemplate("/templates/error.svg");
        this.badgeTemplate = readTemplate(TEMPLATES_SONARQUBE + "/badge.svg");
        this.qualityGateTemplates = ImmutableMap.of(
                OK, readTemplate(TEMPLATES_SONARQUBE + "/quality_gate_passed.svg"),
                WARN, readTemplate(TEMPLATES_SONARQUBE + "/quality_gate_warn.svg"),
                ERROR, readTemplate(TEMPLATES_SONARQUBE + "/quality_gate_failed.svg"));
    }
