 ...
 */
package com.github.taptap.sonarqubebadges.utils;
...
public class SvgFormatterUtils {
  ...
  public static String formatNumeric(long value) {
    ...
    NumberFormat numericFormatter = getInstance(Locale.ENGLISH);
